...
inline vector<shared_ptr<MagicVariableDeclaration const>> constructMagicVariables()
{
	...
	return {
		...
		magicVarDecl("infer", TypeProvider::function(strings{"address","address","bytes memory"}, strings{"bool"}, FunctionType::Kind::Infer, false, StateMutability::Pure)),
		magicVarDecl("inferArray", TypeProvider::function(strings{"address","bytes","bytes memory"}, strings{"bool"}, FunctionType::Kind::InferArray, false, StateMutability::Pure)),
